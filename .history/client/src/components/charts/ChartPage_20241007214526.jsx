...
function ChartPage({ report, setShowChart, showChart, fetchingData }) {
  ...
  const dataMap = {
    ...
    "/personalWorkers": fetchingData?.personalWorkers,
    "personalWorkersCharts": fetchingData?.personalWorkers,
    "/personalSales": fetchingData?.personalSales,
    "personalSalesCharts": fetchingData?.personalSales,
    "/personalRkrExpenses": fetchingData?.personalRkrExpenses,
    "personalRkrExpensesCharts": fetchingData?.personalRkrExpenses,
