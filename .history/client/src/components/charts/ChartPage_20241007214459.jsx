...
function ChartPage({ report, setShowChart, showChart, fetchingData }) {
  ...
  const dataMap = {
    ...
    "/personalProductExpenses": fetchingData?.personalProductExpenses,
    "personalProductExpensesCharts": fetchingData?.expensesData,
    "/personalWorkers": fetchingData?.expensesData,
    "personalWorkersCharts": fetchingData?.expensesData,
    "/personalSales": fetchingData?.expensesData,
    "personalSalesCharts": fetchingData?.expensesData,
    "/personalRkrExpenses": fetchingData?.expensesData,
    "personalRkrExpensesCharts": fetchingData?.expensesData,
