...
function ChartHomepage() {
  ...
  const allTypes = [
    ...
    { type: "personalProductExpensesChart", name: " תרשים הוצאות חומרים פרטי" },
  ...
  const sendRequest = async (token) => {
    ...
    const { data: personalProductExpensesData } = await Api.get("/personalProductExpenses", { headers });
    const { data: personalSalesData } = await Api.get("/personalSales", { headers });
    const { data: personalWorkersData} = await Api.get("/personalWorkers", { headers });
    const { data: personalRkrExpensesData } = await Api.get("/personalRkrExpenses", { headers });
    ...
    setFetchingData({
      ...
      personalProductExpensesData: expensesData,
      personalSalesData: expensesData,
      personalWorkersData: expensesData,
      prersonalRkrExpensesData: expensesData,
    });
  };
