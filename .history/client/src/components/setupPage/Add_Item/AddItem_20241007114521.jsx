      ...
      <div className="add-row">
        ...
        {itemsValues?.product?.length > 0 && (
          <div className="Productquantities" style={{top :" 20vh"}}>
            ...
            <div style={{display : "flex" , justifyContent : "center",color : "brown" , fontWeight : "bold"}}>
            <input
        ...
        {collReq !== "/personalWorkers" && (
          <input
            ...
            required
            className="add_item"
            placeholder={collReq === "/sales" ? "שטח" :collReq === "/personalRkrExpenses" ? "דונומים" : "כמות"}
            onChange={(e) => {
              setItemsValues((prev) => {
        ...
        {collReq === "/personalRkrExpenses" && (
          <input
            ...
            onChange={(e) =>
              setItemsValues((prev) => {
                return { ...prev, workPrice: e.target.value };
              })
            }
