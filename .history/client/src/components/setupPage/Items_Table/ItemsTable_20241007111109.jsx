        ...
        >
          ...
          {collReq === "/personalRkrExpenses" && (
            <input
              ...
              onChange={(selectedOptions) => {
                const keysOfProductNames = itemsValues?.product.map(
                  (obj) => obj["label"]
                );
                setItemsValues((prev) => {
                  const myNewPrices = getProductKeys(
                  ...
                  return {
                    ...prev,
                    workPrice : +selectedOptions.target.validationMessage
                    totalAmount: +sumOfPrices + +selectedOptions.target.value,
                  };
                });
              }}
            ></input>
