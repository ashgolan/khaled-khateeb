...
export default function ItemsTable({
  ...
  const [hideProductquantitiesDiv, setHideProductquantitiesDiv] =
    useState(true);
  useEffect(() => {
    const getData = async () => {
        ...
        >
          ...
          {((itemsValues?.product?.length > 0 && !changeStatus.disabled) &
            ...
            <div className="Productquantities">
              ...
              <button onClick={(e) => {e.preventDefault(); setHideProductquantitiesDiv(true)}}>
                hide
              </button>
            </div>
          )}
              ...
              onChange={(e) => {
                setItemsValues((prev) => {
                  return {
                    ...
                    totalAmount: +e.target.value + prev.sumOfPrices,
                  };
                });
              }}
            ></input>
